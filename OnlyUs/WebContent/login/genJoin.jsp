...
<div class="layer-tooltip" id="layerTooltip">
	<span class="ico"></span>
	<p>상품 가격은 쿠폰이 적용된 가격이며,<br>
		쇼핑몰 결제 페이지에서 쿠폰을 적용해야<br>
		해당 가격으로 구매 가능합니다.</p>
</div>

<!-- 2015-09-23 면세점 카테고리 상품 가격 노티 -->
<div class="layer-tooltip dutyfree" id="layerDutyfree">
	<span class="ico"></span>
	<p>면세점 상품은 환율에 따라<br>실제 판매가와 상이할 수 있습니다.</p>
</div>

<div class="layer-blank" style="display:none;"></div>
<div class="popup-sns-wrap" style="display:none;">
<div class="popup-leave join_leave " style="display:none;">
	<h4>회원탈퇴</h4>
	<div class="text-desc">
		회원탈퇴를 하시면 모든 정보가 삭제되며, 탈퇴하신 계정의 아이디는 다시 이용할 수 없습니다.<br>
		신중하게 결정하셔서 진행해주세요.
	</div>
	<div class="table-form"> 
		<table>
						...
						<span class="text-id" id="outId" style="display:none;"></span>
					
				
			<tr>
				<th scope="row">탈퇴사유</th>
				<td>
					<span class="select-leave">
						<select data-scroll="false" id="outCode">
							<option  value="아이디변경" data-code="A">아이디변경</option>
							<option  value="서비스불만" data-code="B">서비스불만</option>
							<option  value="서비스불필요" data-code="C">서비스불필요</option>
							<option value="기타" data-code="Z">기타</option>
						</select>
					</span>
					<input type="text" id="outText" disabled="disabled">
				</td>
			</tr>
		</table>
	</div>
