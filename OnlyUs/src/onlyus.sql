...
commit;
insert into coupon values('c13','9','2016-10-01','2016-11-01','N',0,'s4','5000이상 구매시 초코바나나 L 증정'); 
insert into coupon values('c14','9','2016-10-01','2016-11-01','N',0,'s4','1000원 할인권(10000원이상 구매시)'); 
insert into coupon values('c15','9','2016-10-01','2016-11-01','N',0,'s4','200원 할인권'); 
insert into coupon values('c16','9','2016-10-01','2016-11-01','N',0,'s4','500원 할인권');
commit;
insert into coupon values('c17','9','2016-10-01','2016-11-01','N',0,'s5','소프트콘 무료'); 
insert into coupon values('c18','9','2016-10-01','2016-11-01','N',0,'s5','단품구매시 세트'); 
insert into coupon values('c19','9','2016-10-01','2016-11-01','N',0,'s5','감자튀김 => 양념감자'); 
insert into coupon values('c20','9','2016-10-01','2016-11-01','N',0,'s5','콜라 무료'); 

insert into coupon values('c21','9','2016-10-01','2016-11-01','N',0,'s6','300원 할인권'); 
insert into coupon values('c22','9','2016-10-01','2016-11-01','N',0,'s6','1000원 할인권(10000원이상 구매시)'); 
insert into coupon values('c23','9','2016-10-01','2016-11-01','N',0,'s6','도리뱅뱅 맛보기'); 
insert into coupon values('c24','9','2016-10-01','2016-11-01','N',0,'s6','10프로 할인권'); 
insert into coupon values('c25','9','2016-10-01','2016-11-01','N',0,'s6','1000원 할인권2(10000원이상 구매시)'); 
commit;
insert into coupon values('c26','9','2016-10-01','2016-11-01','N',0,'s7','닭갈비 3인분이상 주문시 100g 무료 추가'); 
insert into coupon values('c27','9','2016-10-01','2016-11-01','N',0,'s7','막국수 맛보기'); 
insert into coupon values('c28','9','2016-10-01','2016-11-01','N',0,'s7','포장시 5프로 할인권'); 
insert into coupon values('c29','9','2016-10-01','2016-11-01','N',0,'s7','막국수 2000원할인권'); 
commit;
insert into coupon values('c30','9','2016-10-01','2016-11-01','N',0,'s8','파운드케잌 1000원 할인권'); 
insert into coupon values('c31','9','2016-10-01','2016-11-01','N',0,'s8','10% 할인권'); 
insert into coupon values('c32','9','2016-10-01','2016-11-01','N',0,'s8','크림 치즈빵 2000원권'); 
insert into coupon values('c33','9','2016-10-01','2016-11-01','N',0,'s8','해피피넛 밀크쉐이크 맛보기권'); 
commit;
insert into coupon values('c34','9','2016-10-01','2016-11-01','N',0,'s9','핫소스 무료 추가'); 
insert into coupon values('c35','9','2016-10-01','2016-11-01','N',0,'s9','세트메뉴 1000원 할인권'); 
insert into coupon values('c36','9','2016-10-01','2016-11-01','N',0,'s9','샐러드 3000원권'); 
insert into coupon values('c37','9','2016-10-01','2016-11-01','N',0,'s9','탄산음료 무료 쿠폰'); 
commit;
insert into coupon values('c38','9','2016-10-01','2016-11-01','N',0,'s10','국수 2그릇 구매시 1000원 할인권)'); 
insert into coupon values('c39','9','2016-10-01','2016-11-01','N',0,'s10','돔베고기 맛보기 찬스'); 
insert into coupon values('c40','9','2016-10-01','2016-11-01','N',0,'s10','비빔국수 곱배기권');
commit;
